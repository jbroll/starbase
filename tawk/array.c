...
ANODE* PROTO(find_by_ival,(ARRAY, Int, int)) ;
ANODE* PROTO(find_by_sval,(ARRAY, STRING*, int)) ;
...
ANODE* find_by_ival(A, ival, create_flag)
   ARRAY A ;
   Int ival ;
   int create_flag ;
{
...
ANODE* find_by_sval(A, sval, create_flag)
   ARRAY A ;
   STRING *sval ;
   int create_flag ;
{
